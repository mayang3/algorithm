...
/**
 * bit mask 를 사용하는 eratosthenes seive
 *
 * {@link EratosthenesBitMask_GFG} 보다 훨씬 많은 범위를 처리 가능하다.
 */
public class EratosthenesBitMask_GFG {
	...
	{
		// Assuming that n takes 32 bits(4byte),
